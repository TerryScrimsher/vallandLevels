var level1potshop = function(game) {
...
//    layer2 = map.createLayer('Underlay');
    ...
    var text2 = this.game.add.bitmapText(60, 60, 'sakredfont', 'Valland: Potion Shop', 52);
...
//        this.game.debug.body(exitPotshop);
  ...
  exitLevel: function() {
    this.game.state.start("Level1", true, false, 1752, 1620, "down");
  }

}

console.log("%cTown: Potionshop", "color:white; background:red");
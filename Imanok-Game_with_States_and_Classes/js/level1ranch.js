...
level1ranch.prototype = {
  ...
  create: function() {
    ...
    map = this.game.add.tilemap('levelMap1-ranch');
    ...
    var text2 = this.game.add.bitmapText(40, 30, 'sakredfont', 'Town: Ranch', 52);

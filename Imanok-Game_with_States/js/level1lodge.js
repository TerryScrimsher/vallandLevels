...
level1lodge.prototype = {
  ...
  create: function() {
    ...
    map = this.game.add.tilemap('levelMap1-lodge');
...
//    layer2 = map.createLayer('Underlay');
    ...
    var text2 = this.game.add.bitmapText(60, 60, 'sakredfont', 'Valland: Lodge', 52);
...
console.log("%cLevel1 Lodge", "color:white; background:red");
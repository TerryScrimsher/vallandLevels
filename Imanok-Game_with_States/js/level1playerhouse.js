var level1playerhouse = function(game) {
...
level1playerhouse.prototype = {
  ...
  create: function() {
    ...
    map = this.game.add.tilemap('levelMap1-playerhouse');
...
//    layer2 = map.createLayer('Underlay');
    ...
    npc1 = this.game.add.sprite(615, 598, 'emoteSprite', 1);
    ...
    var text2 = this.game.add.bitmapText(60, 60, 'sakredfont', 'Valland: House', 52);
...
console.log("%cLevel1 Player House", "color:white; background:red");